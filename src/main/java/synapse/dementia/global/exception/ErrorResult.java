...
public enum ErrorResult {
	...
	SECOND_PASSWORD_MISMATCH_BAD_REQUEST(HttpStatus.BAD_REQUEST, "SECOND_PASSWORD_MISMATCH_BAD_REQUEST", "PMB002"),
	USER_NOT_EXIST_BAD_REQUEST(HttpStatus.BAD_REQUEST, "USER_NOT_EXIST_BAD_REQUEST", "NNB003"),
	// SERVER
